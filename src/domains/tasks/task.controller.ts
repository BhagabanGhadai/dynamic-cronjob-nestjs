...
export class TaskController {
    ...
    @ApiParam({ name: '_id', description: 'MongoDB ObjectId of the task', example: '665893abc921470ef4801123' })
    @ApiResponse({
        status: 200,
    ...
    @Post()
    @ApiOperation({ summary: 'Create and schedule a new task (cron, interval, or timeout)' })
    ...
    @ApiParam({ name: '_id', description: 'MongoDB ObjectId of the task to delete', example: '665893abc921470ef4801123' })
    @ApiResponse({
        status: 200,
